								...
								<div class="main-ws-sec">
									...
									<div class="product-feed-tab" id="info-dd">
										<div class="user-profile-ov">
											<h3><a href="#" title="" class="overview-open">Información General</a> <a href="#" title="" class="overview-open"><i class="fa fa-pencil"></i></a></h3>
											<h4>Fecha de Nacimiento: </h4><h5>${fecha_nacimiento}</h5>
										</div><!--user-profile-ov end-->

										<div class="user-profile-ov">
											<h3><a href="#" title="" class="lct-box-open">Lugar de Nacimiento</a> <a href="#" title="" class="lct-box-open"><i class="fa fa-pencil"></i></a> <a href="#" title=""><i class="fa fa-plus-square"></i></a></h3>
											<h4>${pais_origen}</h4>
											<p> ${ciudad_origen} </p>
										</div><!--user-profile-ov end-->
										...
										<#if lugar_estudio??>
											<div class="user-profile-ov">
											<h3><a href="#" title="" class="overview-open">Centro de Estudio</a> <a href="#" title="" class="overview-open"><i class="fa fa-pencil"></i></a></h3>
												<h4>${lugar_estudio}</h4>
											</div><!--user-profile-ov end-->
										</#if>
										<#if trabajo??>
											<div class="user-profile-ov st2">
												<h3><a href="#" title="" class="overview-open">Centro de Trabajo</a> <a href="#" title="" class="overview-open"><i class="fa fa-pencil"></i></a></h3>
												<h4>${trabajo}</h4>
											</div><!--user-profile-ov end-->
										</#if>
									</div><!--#fin - Tab info-->
